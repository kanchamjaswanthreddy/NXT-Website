    ...
    <footer className="bg-midnight on-dark">
      <div className="container py-16 md:py-20">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[1.4fr_1fr_1fr] md:gap-16">
          <div>
            <Link href="/" aria-label="NXT Financial Group"><Image src="/logo-white.png" alt="NXT Financial Group" width={190} height={84} className="h-12 w-auto brightness-0 invert" /></Link>
