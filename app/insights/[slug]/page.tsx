...
export default async function PostPage({ params }: Params) {
  ...
  return (<>
    ...
    <article className="section pt-12"><div className="container max-w-[880px]"><div className="relative mb-12 aspect-[16/9] overflow-hidden rounded-[24px] bg-stone"><Image src={post.image} alt={post.title} fill priority sizes="880px" className="object-cover" style={{ filter: 'saturate(0.85)' }} /></div>
