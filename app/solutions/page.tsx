...
export const metadata: Metadata = { title: 'Insurance Solutions — 6 Disciplines', description: 'Annuities, life insurance, care planning, Medicare planning, disability income and home & auto insurance — six disciplines, 70+ carriers, one IMO. NXT Financial Group compares them all.', alternates: { canonical: 'https://www.nxtfinancialgroup.com/solutions' } }
